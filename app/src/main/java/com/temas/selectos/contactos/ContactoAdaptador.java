...
public class ContactoAdaptador extends RecyclerView.Adapter <ContactoAdaptador.ContactoViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ContactoViewHolder contactoViewHolder, int posicion) {
            ...
            contactoViewHolder.tbContacto.inflateMenu(R.menu.menu_layout);
            contactoViewHolder.tbContacto.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
                @Override
                public boolean onMenuItemClick(MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        ...
                        case R.id.Editar:
                            ...
                            Toast.makeText(activity.getApplicationContext(), "Editar", Toast.LENGTH_SHORT).show();
                            break;
                        case R.id.Compartir:



                            Toast.makeText(activity.getApplicationContext(), "Compartir", Toast.LENGTH_SHORT).show();
                            break;
                    }
    ...
    public static class ContactoViewHolder extends RecyclerView.ViewHolder{
        ...
        public ContactoViewHolder(@NonNull View itemView) {
            ...
            tbContacto = itemView.findViewById(R.id.tbContacto);
